...
const LANGUAGE_OPTIONS = [
  { value: 'en', labelKey: 'common.language.english', ariaKey: 'common.language.switchToEnglish' },
  { value: 'ru', labelKey: 'common.language.russian', ariaKey: 'common.language.switchToRussian' },
];
